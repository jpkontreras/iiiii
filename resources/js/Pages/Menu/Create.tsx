...
const templateTypes = [
  {
    ...
    name: 'Standard Menu',
    description: 'A classic menu layout with sections and categories',
    icon: FileText,
  },
  {
    id: 'qr_code' as const,
    name: 'QR Code Menu',
    description: 'Mobile-optimized menu perfect for QR code scanning',
    icon: ImageIcon,
  },
  {
    id: 'digital_display' as const,
    name: 'Digital Display',
    description: 'Dynamic menu for digital screens and kiosks',
    icon: Table,
  },
];
          ...
          <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            <div className="p-6">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">
                      Quick Import Your Menu
                    </h3>
                    <p className="mt-1 text-sm text-gray-500">
                      Save time by importing your existing menu from images,
                      PDFs, or spreadsheets. Our AI will automatically extract
                      and organize your menu items.
                    </p>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-2 text-xs text-gray-500">
                        Support for images (JPG, PNG), PDFs, Excel files, and
                        CSV
                      </p>
                    </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <InputLabel value="Menu Template" />
